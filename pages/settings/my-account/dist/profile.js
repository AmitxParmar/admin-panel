    ...
    return (react_1["default"].createElement(SettingsWrapper_1["default"], null,
        react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement("div", { className: "flex" },
                react_1["default"].createElement(image_1["default"], { height: 64, width: 64, alt: "Profile Pic", className: "w-16 h-16 rounded-full", src: "https://www.gravatar.com/avatar/fallback?s=160&d=mp&r=PG" }),
                react_1["default"].createElement("button", { className: "w-[130px] h-9 font-medium rounded-md border-[1px] my-auto mx-[16px] text-[0.875rem] border-lightgray" }, "Change Avatar")),
            react_1["default"].createElement("div", { className: 'mt-8' },
                ...
                react_1["default"].createElement("div", { className: "flex rounded-md" },
                    react_1["default"].createElement("span", { className: "border-default bg-muted text-subtle hidden h-[35] items-center rounded-l-md border border-r-0 px-3 text-sm md:inline-flex" }, "cal.com/"),
            ...
            react_1["default"].createElement("div", { className: "h-fit scrollbar-thin max-w-[764px] overflow-x-hidden overflow-y-scroll" },
