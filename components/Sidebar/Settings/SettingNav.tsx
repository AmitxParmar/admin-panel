        ...
        <div className="">
          ...
          <div className='mt-'>
            <div className="[&amp;[aria-current='page']]:bg-emphasis [&amp;[aria-current='page']]:text-emphasis text-default group flex h-9 w-64 flex-row items-center rounded-md px-2 text-sm font-medium leading-none">
              <img className="h-4 w-4 rounded-full mr-3 ltr:mr-3 rtl:ml-3" src="https://www.gravatar.com/avatar/fallback?s=160&d=mp&r=PG" alt="User Avatar" />
          ...
          <div className='my-2 space-y-1'>
            ...
            <Link
              href={"/settings/my-account/profile"}
              className={`text-emphasis font-medium text-sm min-h-8 hover:bg-subtle [&[aria-current='page']]:bg-emphasis [&[aria-current='page']]:text-emphasis group-hover:text-default max-w-[156px] group flex flex-row items-center rounded-md px-3 py-[10px] ml-7 max-w-6 mr-5 rtl:ml-5 my-0.5 h-7 false font-inter ${(router.pathname === "/settings/my-account/general") ? "bg-emphasis" : ""}`}>
              General
            </Link>
            <Link
              href={"/settings/my-account/profile"}
            ...
            <Link
              href={"/settings/my-account/profile"}
              className={`text-emphasis font-medium text-sm min-h-8 hover:bg-subtle [&[aria-current='page']]:bg-emphasis [&[aria-current='page']]:text-emphasis group-hover:text-default max-w-[156px] group flex flex-row items-center rounded-md px-3 py-[10px] ml-7 max-w-6 mr-5 rtl:ml-5 my-0.5 h-7 false font-inter ${(router.pathname === "/settings/my-account/conferencing") ? "bg-emphasis" : ""}`}>
              Conferencing
            </Link>
            <Link
              href={"/settings/my-account/profile"}
